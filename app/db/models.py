...
class Employee(Base):
    ...
    primary_store_id: Mapped[int | None] = mapped_column(ForeignKey("stores.id", ondelete="SET NULL"), nullable=True, index=True)
    app_theme: Mapped[str] = mapped_column(String(16), default="light")
