...
from app.db.models import User,PhotoRequest,Photo,ShiftReport,ShiftReportValue,Inspection,Task,CashCollection,PriceListUploadRequest,PriceList
...
def handle_update(update:dict):
    ...
    if document:
        with session_scope() as db:
            ...
            if not req:
                send_message(tid,"Сейчас Core не ожидает файл. Сначала нажмите «Прикрепить прайс-лист» в разделе Заявки → Админ.");return
            db.add(PriceList(
