...
from config import DATABASE_URL_DIRECT, DATABASE_URL
from database.db import Base, _psycopg_url
...
def get_url():
    ...
    if not url:
        raise RuntimeError("DATABASE_URL_DIRECT/DATABASE_URL is not configured")
